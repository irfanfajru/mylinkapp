...
<body>
    ...
    <div class="container text-center mt-1 mb-5" id="content">
        ...
        <div class="container rounded shadow bg-white p-1">
            ...
            <div class="row" data-aos="zoom-in" data-aos-duration="1300">
                <div class="col-10 col-md-11 text-end pt-3">
                    <p><svg xmlns="http://www.w3.org/2000/svg" class="text-success" width="16" height="16" fill="currentColor" class="bi bi-check-circle" viewBox="0 0 16 16">
                        ...
                        </svg> Hallo,you can contact to my developer</p>
                </div>
            ...
            <div class="row" data-aos="zoom-in" data-aos-duration="1300">
                <div class="col-10 col-md-11 text-end pt-3">
                    <p><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                            <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z" />
                        </svg> <a href="https:/irfanfajru.github.io" target="_blank" style="text-decoration: none;">IrfanFajru</a></p>
                </div>
                <div class="col-2 col-md-1">
                    <img src="{{asset('images/avaf.svg')}}" class="img-fluid rounded-pill mt-2" alt="">
                </div>
            ...
            <div class="row" data-aos="zoom-in" data-aos-duration="1300">
                <div class="col-10 col-md-11 text-end pt-3">
                    <p><svg xmlns="http://www.w3.org/2000/svg" class="text-success" width="16" height="16" fill="currentColor" class="bi bi-check-circle" viewBox="0 0 16 16">
                            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                            <path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z" />
                        </svg> Or you can directly send email to me</p>
                </div>
                <div class="col-2 col-md-1">
                    <img src="{{asset('images/avaf.svg')}}" class="img-fluid rounded-pill mt-2" alt="">
                </div>
            ...
            <div class="row" data-aos="zoom-in" data-aos-duration="1300">
                ...
                <div class="col-10 col-md-5 text-start pt-3">
                    <form action="">
                        <input type="text" class="form-control shadow-sm" placeholder="Your Name...">
                        <input type="email" class="form-control mt-2 shadow-sm" placeholder="Your Email...">
                        <input type="text" class="form-control mt-2 shadow-sm" placeholder="Your Question...">
                        <button type="submit" class="btn btn-success w-100 mt-2 mb-3 runded-3 shadow-sm">Send</button>
                    </form>
                </div>
            </div>
        </div>
